...
int8_t digits[NUM_DIGITS][13][2] = {
  ...
  { {1,0}, {1,0}, {2,0}, {0,1}, {0,1}, {0,2}, {1,2}, {2,2}, {2,3}, {2,3}, {0,4}, {1,4}, {1,4} },    // S // 35
  ...
  // Specific Cyrillic Chars
  { {0,0}, {1,0}, {2,0}, {0,1}, {0,1}, {0,2}, {1,2}, {1,2}, {0,3}, {2,3}, {0,4}, {1,4}, {1,4} },    // Б // 49
  { {0,0}, {1,0}, {2,0}, {0,1}, {2,1}, {0,2}, {2,2}, {2,2}, {0,3}, {2,3}, {0,4}, {2,4}, {2,4} },    // П // 50
  { {0,0}, {0,0}, {2,0}, {0,1}, {2,1}, {1,2}, {1,2}, {2,2}, {2,3}, {2,3}, {2,4}, {2,4}, {2,4} },    // Ч // 51
  { {1,0}, {1,0}, {2,0}, {0,1}, {2,1}, {0,2}, {2,2}, {2,2}, {0,3}, {2,3}, {0,4}, {1,3}, {2,4} }     // Д // 52
};
...
uint8_t digitCorners[NUM_DIGITS][13];
